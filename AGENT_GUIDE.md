...
- By default, follow learner-selected public Telegram channels and social pages that are readable without signing in. Keep collection read-only. A local export or host connector may be used only when the learner is authorized to provide that access.
